...
class CodeWriter:
    ...
    def __setFuncName(self, func_name: str) -> None:
        """Sets the function name, this will be used to determine the label name.
        
        Args:
            func_name (str): The name of the current function we are in."""
    ...
    def __g_lbl_name(self, label: str) -> str:
        if self.__func_name:
            return self.__func_name + "$" + label
        
        return self.__file_name + "$" + label
    ...
    def write_label(self, label: str) -> None:
        ...
        self.__output_file.write("(" + lblname + ")\n")
    ...
    def write_if(self, label: str) -> None:
        ...
        if self.__func_name:
            output += "@" + self.__func_name + "$" + label + "\n" + \
                     "D;JNE\n"
        
        else:
            output += "@" + self.__file_name + "$" + label + "\n" + \
                    "D;JNE\n"
    ...
    def write_function(self, function_name: str, n_vars: int) -> None:
        ...
        """
        # Update the CodeWriter's current function
        # This is for creating a proper label
        self.__setFuncName(function_name)
